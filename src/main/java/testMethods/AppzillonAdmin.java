...
public class AppzillonAdmin {
    ...
    public void in_login_give_username_as_and_password_as_and_click_login_button(String username, String password) {
        ...
        explicit("Admin__Login__element_button_1",8);
        driver.findElement(By.id("Admin__Login__element_button_1")).click();
    }
    @Then("Click the Satff Maintenance in Bank Parameter drop down")
    ...
    public void click_the_table_displaying_content_in_user_i_d_column() {

    }
    @When("in following screen click the unloack button and click the Dateof Birth field")
    public void in_following_screen_click_the_unloack_button_and_click_the_dateof_birth_field() {
    ...
    @Then("Choose the year as {string} and momth as {string} and Date as {string}")
    ...
    @Then("Click the save buton")
    public void click_the_save_buton() throws InterruptedException {
        Thread.sleep(2000);
